  ...
  return (
    <>
      ...
      >
        ...
        <Box>
          <a href="https://github.com/ArpitshrivastavaAA">
            <Image
              width={{ base: "300px", md: "520px", lg: "500px" }}
              src={`https://github-readme-stats.vercel.app/api?username=ArpitshrivastavaAA&show_icons=true&locale=en&show_icons=true&theme=${
        ...
        <Box>
          <a href="https://github.com/ArpitshrivastavaAA">
            <Image
              ...
              src={`https://github-readme-stats.vercel.app/api/top-langs?username=ArpitshrivastavaAA&show_icons=true&locale=en&layout=compact&langs_count=5&theme=${
                Theme === "light" ? "buefy" : "midnight-purple"
              }&show_icons=true`}
            />
          </a>
